      ...
      <div className="container px-5 py-3 mx-auto">
        ...
        <div className="flex flex-wrap -m-4 text-center">
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-200 bg-white px-4 py-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-200 bg-white px-4 py-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              ...
              <p className="leading-relaxed">Lectures</p>
            </div>
          </div>
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-200 bg-white px-4 py-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              ...
              <p className= "leading-relaxed">Security Checks</p>
            </div>
          </div>
        </div>
      </div>
